...
const int relay_valve1 = 4;   //defining ports of solenoid valves
const int relay_valve2 = 5;
const int relay_pump = 6;     //defining port of water pump 
...
void loop() { //main loop of the system
  ...
  digitalWrite(relay_valve1, LOW); //turns off the valve
